<template>
  <footer :class="{ 'brdr-top-1 brdr-cl-secondary': isCheckoutPage }">
    ...
    <KlaviyoNewsletter class=" flex brdr-bottom-1 brdr-cl-secondary" v-if="!isCheckoutPage"/>
...
import KlaviyoNewsletter from 'theme/components/core/blocks/Footer/KlaviyoNewsletter'
